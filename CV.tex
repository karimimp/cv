...
\begin{list}{}{}
\item Worked with \href{http://bit.ly/2CYF9sp}{Professor Marchisio} on \quotes{Modelling of Morphology Development of Micro and Nano Structures, \href{https://github.com/MoDeNa-EUProject/MoDeNa}{(MoDeNa)}} project. Developed a new solver, \href{https://github.com/karimimp/PUFoam}{\texttt{PUFoam}}, in OpenFOAM based on coupling of PBE with CFD for simulation of reacting expanding polyurethane foams.
...
\begin{enumerate}
	\item
\underline{M. Karimi}, R. Andersson, \quotes{An exploratory study of fluid particles breakup rate models for the entire spectrum of turbulent energy}, \textit{Chemical Engineering Science}, Vol. 192, pp. 850--863, 2018.
	\item
B. Oyegbile, G. Akdogan, \underline{M. Karimi}, \quotes{Experimental and CFD Studies of the Hydrodynamics in Wet Agglomeration Process}, \textit{ChemEngineering}, Vol. 2, pp. 1--17, 2018.
	\item 
