...
\vspace{0.2cm}
\begin{list}{}{}
\item Researcher in Computational Fluid Dynamics with a passion for multiphase systems and programming. Over eight years of experience developing and applying CFD models for a range of problems in chemical engineering and mineral processing fields.
\end{list}
\vspace{0.1cm}
...
\begin{list}{}{}
\item Working with Professor Marchisio on \quotes{Modelling of Morphology Development of Micro and Nano Structures \href{http://www.modenaproject.eu/}{(MoDeNa)}} project aiming to develop, demonstrate and evaluate a modelling platform for polyurethane foams. 
...
\begin{enumerate}
	\item 
\underline{M. Karimi}, H. Droghetti, D. L. Marchisio, \quotes{PUFoam: a novel open-source CFD solver for the simulation of expanding and reacting polyurethane foams}, submitted to \textit{Computer Physics Communications}, July 2016.
	\item
...
\vspace{0.2cm}
\begin{list}{}{}
	\item \textbf{Pre-processing:} Proficient in Design Modeller and GAMBIT, familiar with SALOME.
